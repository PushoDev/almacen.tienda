...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::prefix('reportes')->name('reportes.')->group(function () {
        // --- PAGINA PRINCIPAL --- (todos los roles; el frontend ya decide qué secciones
        // mostrarle a cada uno, ver Reportes/Index.tsx)
        ...
        // con su abort(403) manual. Middleware 'admin' (EnsureUserIsAdmin) ya permite ambos
        // roles, no hace falta uno nuevo.
