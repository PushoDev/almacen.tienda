...
- [ ] **Rutas rotas**: `POST /ventas/validar-stock` y `POST /ventas/actualizar-tasas` sin método en `VentaController`; `POST /movimientos/{movimiento}/aprobar` sin método `aprobar()` en `MovimientosController` (encontrado 2026-08-22) — implementar o eliminar cada ruta.
