...
export default function CreateAlmacenesPage() {
    // Manejo del formulario con useForm - incluyendo los nuevos campos
    const { data, setData, post, reset, errors, processing } = useForm({
        ...
        ciudad_almacen: '',
        notas_almacen: '',
        tipo_almacen: 'punto_venta', // Valor por defecto
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                <div className="bg-sidebar border-sidebar-accent relative col-span-4 space-y-1 overflow-hidden rounded-2xl border border-dashed p-4">
                    <HeadingSmall
                        ...
                        description="Complete la información del local y del responsable para registrar un nuevo almacén, punto de venta o vehículo de transportación"
                    />
                    <Warehouse
                        size={70}
                        color="#d6d3d1"
                    ...
                    <form onSubmit={submit} className="space-y-6 p-6">
                        ...
                        <div className="flex justify-end gap-4 pt-4">
                            ...
                            <Button type="submit" disabled={processing} className="min-w-[120px] bg-indigo-600 hover:bg-indigo-700">
                                {processing ? 'Creando...' : 'Crear Almacén'}
                            </Button>
                        </div>
                    </form>
                </div>
