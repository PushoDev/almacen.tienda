...
import { AlertTriangle, Edit2, Package2, Warehouse } from 'lucide-react';
                        ...
                        <div className="space-y-4 md:col-span-2">
                            <div className="grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium">{producto.cantidad_total} unidades</p>
                                </div>
                                <div>
                                    <p className="text-muted-foreground text-sm">Estado Stock</p>
                        ...
                        {producto.almacenes && producto.almacenes.length > 0 ? (
                            <div className="space-y-4">
                                {producto.almacenes.map((almacen) => (
                                    <div
                                        key={almacen.id}
                                        className={`rounded-lg border p-4 ${almacen.stock_bajo ? 'bg-red-100 dark:bg-red-900/20' : ''}`}
                                    >
                                        <div>
                                            ...
                                            <div className="flex h-5 items-center space-x-4 text-sm">
                                                ...
                                                <p className="text-muted-foreground">
                                                    <span className="font-bold">{almacen.cantidad} unidades</span>
                                                </p>
                                            ...
                                            <AccordionItem value="item-1">
                                                ...
                                                <AccordionContent className="flex flex-col gap-4 text-balance">
                                                    ...
                                                    <p className="text-muted-foreground text-sm">
                                                        ...
                                                        <span className={`font-bold ${almacen.stock_bajo ? 'text-red-600' : ''}`}>
